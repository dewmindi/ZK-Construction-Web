...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    description: "Zane's role of chief executive officer brings a wealth of expertise as a licensed tradesman. His deep understanding of construction processes, regulatory compliance, and quality standards equips him to lead projects with precision. Zane's extensive experience in the field ensures effective coordination of diverse teams, resource optimisation, and diligent oversight of project execution. His attention to detail and commitment to adhering to timelines and budgets instills confidence in clients and stakeholders alike. Zane's experience enhances the company's ability to navigate intricate regulatory frameworks, facilitating the smooth progression of projects from conceptualisation to completion. With a focus on fostering collaboration, driving operational efficiency, and maintaining rigorous quality control, Zane's role is integral in delivering ZK Construction's promise of excellence.",
    image: "/team/ZaneBrache.webp"
  },
  {
    id: "member-2",
    name: "Dr Kenny Tse",
