          ...
          <div>
            ...
            <ul className="space-y-6 text-white/60">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:0476310454" className="text-sm hover:text-white transition-colors">0476310454</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-brand flex-shrink-0" />
                <a href="mailto:info@zkcg.com.au" className="text-sm hover:text-white transition-colors">info@zkcg.com.au</a>
              </li>
              <li className="flex items-center gap-3">
